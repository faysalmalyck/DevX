  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-white dark:bg-[#181d2b] pt-20 pb-16 text-slate-900 transition-colors duration-300 md:pt-32 md:pb-20 dark:text-white">
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 items-stretch overflow-hidden rounded-2xl border border-slate-200 shadow-xl md:grid-cols-3 md:rounded-lg dark:border-slate-600/80 dark:shadow-2xl">
          {plans.map((plan, index) => {
            ...
            return (
              <div
                key={plan.id}
                className={`relative flex min-h-[550px] flex-col justify-between bg-slate-50 p-6 transition-all duration-300 sm:p-8 md:min-h-[650px] md:p-10 lg:p-12 dark:bg-gradient-to-b dark:from-[#252E42] dark:to-[#1A2033] ${
