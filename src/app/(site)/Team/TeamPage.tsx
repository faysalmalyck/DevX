          ...
          <div className="grid grid-cols-1 justify-items-center gap-6 lg:grid-cols-2">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="flex w-full max-w-[596px] flex-col justify-between rounded-lg border border-gray-300 bg-gray-50/50 p-8 transition-colors duration-200 dark:border-[#2f384f] dark:bg-gradient-to-b dark:from-[#252E41] dark:via-[#242D40] dark:to-[#1D2336] sm:p-10 lg:p-12"
              >
