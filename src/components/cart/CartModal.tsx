          ...
          <>
            ...
            <footer className="border-t border-[#414b62] bg-[#111725]/65 px-5 py-4 sm:px-6">
              ...
              <button
                ...
                className="mx-auto mt-3 flex min-h-10 w-full items-center justify-center rounded-full bg-blue-600 px-10 py-3 text-center text-sm font-medium text-white shadow-[0_8px_20px_rgba(36,93,255,0.25)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-500 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] active:translate-y-0 disabled:cursor-wait disabled:opacity-70 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300 sm:w-auto"
              >
                {isCheckingOut
                  ? "Preparing checkout…"
