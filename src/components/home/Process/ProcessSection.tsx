  ...
  return (
    <section className="relative w-full py-6 sm:py-10 px-4 md:px-8 dark:bg-[#181d2b] overflow-hidden transition-colors duration-200">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Action Button */}
        <ScrollReveal
          className="mt-6 sm:mt-8 py-4 sm:py-6 md:py-8 flex justify-center"
          preset="copy"
        >
          <Link
            href="/contact"
            className="w-full max-w-[280px] sm:w-auto sm:max-w-none text-center rounded-full bg-brand px-6 sm:px-10 py-4 sm:py-5 text-lg font-semibold text-white transition-all duration-200 hover:bg-brand hover:shadow-[0_0_20px_rgba(54,88,255,0.4)] active:scale-95"
          >
            Contact us
          </Link>
        </ScrollReveal>
