        ...
        <div className="relative">
          ...
          <ScrollReveal preset="card" className="relative z-10">
            <div className="relative">
              ...
              <div className="absolute -inset-1 animate-pulse rounded-2xl bg-blue-600/40 blur-xl duration-[3000ms]" />
              ...
              <div className="relative overflow-hidden rounded-2xl border border-[#3b4458] bg-[#181e2d] shadow-[0_28px_100px_rgba(2,6,23,0.35)]">
                ...
                >
                  <defs>
                    <linearGradient id="curve1-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="currentColor" stopOpacity="0.1" />
                      <stop offset="50%" stopColor="currentColor" stopOpacity="1" />
                      <stop offset="100%" stopColor="currentColor" stopOpacity="0.1" />
                    </linearGradient>

                    <linearGradient id="curve2-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="currentColor" stopOpacity="0.1" />
                      <stop offset="50%" stopColor="currentColor" stopOpacity="1" />
                      <stop offset="100%" stopColor="currentColor" stopOpacity="0.1" />
                    </linearGradient>
