...
export default function ApplicationFilters({
  ...
  return (
    <section className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#111827] xl:flex-row xl:items-center">
      ...
      <div className="grid gap-3 sm:grid-cols-3 xl:w-auto">
        <label>
          ...
          <select
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-base font-medium text-slate-700 outline-none transition focus:border-brand focus:ring-4 focus:ring-brand/10 dark:border-white/10 dark:bg-zinc-900/60 dark:text-zinc-200"
          >
