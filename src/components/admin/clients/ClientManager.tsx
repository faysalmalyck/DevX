    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            onClick={() => exportCsv()}
            className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-black/20 px-4 py-2.5 text-base font-bold text-zinc-300 hover:text-white transition cursor-pointer"
          >
      ...
      {/* Bulk actions */}
      {selected.length > 0 && (
        <div className="flex items-center gap-3 rounded-lg bg-primary/10 border border-primary/20 p-3 text-base font-bold text-primary animate-fade-in">
