    ...
    <section className="w-full py-20 px-4 md:px-8 bg-white dark:bg-[#181d2b]">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <ScrollReveal preset="heading" className="space-y-4 text-center max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-rote tracking-tight text-slate-900 dark:text-white">
            Have questions? <span className='text-brand'>{" "}We have answers{" "}</span> .
          </h2>
